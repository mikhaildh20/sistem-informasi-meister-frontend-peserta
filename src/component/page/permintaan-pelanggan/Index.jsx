...
export default function PermintaanPelangganIndex({ onChangePage }) {
  ...
  async function handleSent(id) {
    const result = await SweetAlert(
      ...
      "Nomor registrasi marketing akan dibentuk dan data permintaan pelanggan ini tidak dapat diubah lagi oleh bagian Marketing. Apakah Anda yakin ingin mengirim data permintaan pelanggan ini ke bagian engineering dan PPIC untuk dilakukan analisa?",
      "info",
      "Ya, saya yakin!"
    );
