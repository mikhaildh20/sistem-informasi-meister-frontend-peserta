...
export default function SuratPerintahKerjaIndex({ onChangePage }) {
  ...
  async function handleSent(id) {
    const result = await SweetAlert(
      "Kirim Surat Perintah Kerja ke bagian PPIC",
      "Data surat perintah kerja ini tidak dapat diubah lagi oleh bagian Marketing. Apakah Anda yakin ingin mengirim data surat perintah kerja ini ke bagian PPIC?",
      "info",
      "Ya, saya yakin!"
    );
