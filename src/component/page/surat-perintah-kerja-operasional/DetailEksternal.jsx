...
export default function SuratPerintahKerjaOperasionalDetailEksternal({
  onChangePage,
  withID,
}) {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const data2 = await UseFetch(
          API_LINK + "SuratPerintahKerjaOperasional/GetDataProdukByPermintaan3",
          {
              ...
              <a
                ...
                onClick={() =>
                  unggahGambarDetail({
                    ...
                    idProduk: value["Key"],
                    nomorRegistrasiSPK:
                      formDataRef.current["nomorRegistrasiSPK"],
                    namaPelanggan: formDataRef.current["namaPelanggan"],
                    namaProduk: value["Nama Produk/Jasa"],
                    kategori: value["Kategori"].split(" - ")[1],
                  })
                }
              >
                <Icon
                  name={role === "ROL50" ? "file-upload" : "overview"}
                  type="Bold"
                  cssClass="ms-1"
                />
              </a>
  ...
  function unggahGambarDetail(obj) {
    onChangePage("gambarDetail", obj);
  }
        ...
        <div className="card-body p-4">
          <div className="row">
            ...
            <div className="col-lg-3">
              ...
              />
              {!formDataRef.current.statusSPK.includes("Belum Dikonversi") && (
                <Button
                  iconName="calendar-clock"
                  classType="primary btn-sm mb-3"
                  label="Lihat Penjadwalan"
                  onClick={() => onChangePage("scheduling", withID)}
                />
              )}
            </div>
          </div>
