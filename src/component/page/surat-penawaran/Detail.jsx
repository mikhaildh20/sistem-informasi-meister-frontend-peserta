...
const inisialisasiDataRiwayat = [
  {
    Key: null,
    No: null,
    "No. Surat Penawaran": null,
    "Keuntungan (%)": null,
    "Diskon (%)": null,
    "Dicetak Oleh": null,
    "Tanggal Cetak": null,
...
export default function SuratPenawaranDetail({ onChangePage, withID }) {
  ...
  const [dataRiwayat, setDataRiwayat] = useState(inisialisasiDataRiwayat);
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const data3 = await UseFetch(
          API_LINK + "SuratPenawaran/GetDataSuratPenawaranRiwayat",
          { id: withID }
        );
        ...
        if (data3 === "ERROR") {
          ...
          setDataRiwayat(inisialisasiDataRiwayat);
        } else {
          const formattedData = data3.map((value) => ({
            ...value,
            ["Tanggal Cetak"]: formatDate(value["Tanggal Cetak"]),
            Aksi: [
              {
                IconName: "file-download",
                Title: "Unduh Surat Penawaran",
                Function: () => {
                  window.open(FILE_LINK + value["Aksi"], "_blank");
                },
              },
            ],
            Alignment: [
        ...
        <div className="card-body p-4">
          <div className="row">
            ...
            <div className="col-lg-3">
              <Label
                ...
                title="Simulasi Keuntungan dan Diskon"
                data={
                  "Keuntungan: " +
                  parseFloat(formDataRef.current.alternatifRAK.split("#")[0]) +
                  "%\nDiskon: " +
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="card mt-3">
                <div className="card-header bg-secondary-subtle fw-bold">
                  Riwayat Penerbitan Surat Penawaran
                </div>
                <div className="card-body p-4">
                  <div className="row">
                    <div className="col-lg-12">
