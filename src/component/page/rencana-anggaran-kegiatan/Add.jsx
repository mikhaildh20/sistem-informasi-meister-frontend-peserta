...
const inisialisasiDataProduk = [
  {
    ...
    "Biaya Standar Part (Rp)": null,
    "Biaya Proses (Rp)": null,
    "Biaya Alat (Rp)": null,
    "Biaya Engineering (Rp)": null,
    "Total Biaya (Rp)": null,
    Count: 0,
  },
];
...
export default function RencanaAnggaranKegiatanAdd({ onChangePage, withID }) {
  ...
  const [biayaIndirect, setBiayaIndirect] = useState(10);
      ...
      try {
        ...
        if (data2 === "ERROR") {
          ...
          const formattedData = data2.map((value) => ({
            ...
            "Biaya Standar Part (Rp)": separator(
              value["Biaya Standar Part (Rp)"]
            ),
            "Biaya Proses (Rp)": separator(value["Biaya Proses (Rp)"]),
            "Biaya Alat (Rp)": separator(value["Biaya Alat (Rp)"]),
            "Biaya Engineering (Rp)": separator(
              value["Biaya Engineering (Rp)"]
            ),
            "Total Biaya (Rp)": separator(value["Total Biaya (Rp)"]),
            Aksi: [
              {
                IconName: "overview",
                Title: "Lihat Detail Biaya Proses dan Material/Standar Part",
                Function: () => {
          ...
          <div className="card-body p-4">
            <div className="row">
              <div className="col-lg-3">
                <DropDown
                  ...
                  label="Nomor Registrasi Marketing"
                    ...
                    <div className="row">
                      <div className="col-lg-3">
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            setBiayaIndirect(e.target.value);
                          }}
                          onKeyDown={(e) => {
                            if (e.key === "e" || e.key === "E")
                              e.preventDefault();
                      ...
                      <div className="col-lg-3">
                        <Input
                          ...
                          onChange={(e) => {
                            if (e.target.value < 0) e.target.value = 0;
                            setBiayaDelivery(e.target.value);
                          }}
                          onKeyDown={(e) => {
                            if (e.key === "e" || e.key === "E")
                              e.preventDefault();
                      ...
                      <div className="col-lg-3">
                        <Input
                          ...
                          onChange={(e) => {
                            if (e.target.value < 0) e.target.value = 0;
                            setBiayaWarranty(e.target.value);
                          }}
                          onKeyDown={(e) => {
                            if (e.key === "e" || e.key === "E")
                              e.preventDefault();
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="card mt-3">
                  <div className="card-header bg-secondary-subtle fw-bold">
                    Simulasi Total Anggaran dan Perhitungan Harga Jual
                  </div>
                  <div className="card-body p-4">
                    <div className="row">
                      <div className="col-lg-3">
