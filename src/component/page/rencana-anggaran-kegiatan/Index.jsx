...
export default function RencanaAnggaranKegiatanIndex({ onChangePage }) {
  ...
  async function handleSent(id) {
    const result = await SweetAlert(
      ...
      "Data rencana anggaran kegiatan ini tidak dapat diubah lagi oleh bagian Marketing setelah dikirim. Apakah Anda yakin ingin mengirim data rencana anggaran kegiatan ini ke bagian marketing atau direktur produksi untuk dilakukan persetujuan?",
      "info",
      "Ya, saya yakin!"
    );
