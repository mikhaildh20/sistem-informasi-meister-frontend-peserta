      ...
      try {
        ...
        if (data3 === "ERROR") {
          ...
          const formattedData = data3.map((value) => ({
            ...
            Alignment: ["left", "center", "center", "right", "center", "right"],
          }));
      ...
      <form>
        <div className="card">
          <div className="card-header bg-primary fw-medium text-white">
            Detail Biaya Proses dan Material/Standar Part
          </div>
                    ...
                    message={
                      <>
                        ...
                        <div>
                          ...
                          diperlukan untuk pembuatan suatu produk. Detail biaya
                          yang tercantum di halaman ini hanya berlaku{" "}
