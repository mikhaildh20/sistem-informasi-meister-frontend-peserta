        ...
        <div className="d-flex justify-content-end">
          ...
          <div className="my-auto ms-4 mt-2">
            <p
              ...
              onClick={() => (window.location.href = ROOT_LINK + "/notifikasi")}
            >
              <Icon name="envelope" />
              <span className="badge rounded-pill bg-danger position-absolute top-0 end-0 responsiveBadgeNotification">
                {countNotifikasi}
              </span>
            </p>
          </div>
