...
const SuratPerintahKerjaOperasional = lazy(() =>
  import("../page/surat-perintah-kerja-operasional/Root")
);
const PermintaanPembelian = lazy(() =>
  import("../page/permintaan-pembelian/Root")
);
...
const routeList = [
  ...
  {
    path: "/surat_perintah_kerja_operasional",
    element: <SuratPerintahKerjaOperasional />,
  },
  {
    path: "/permintaan_pembelian",
    element: <PermintaanPembelian />,
  },
];
